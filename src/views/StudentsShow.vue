<template>
  <div class="home">
    <div class="container">
      ...
      <span>
        Email: {{ student.email }}, Phone: {{ student.phone_number }}, LinkedIn: {{ student.linkedin_url }}, Twitter:
      ...
      <div v-for="capstone in student.capstones">
        <h3>Capstone:</h3>
        Name:
        <span>{{ capstone.name }}</span>
        <br />
        Description:
        <span>{{ capstone.description }}</span>
        <br />
        Website:
        <span>{{ capstone.url }}</span>
        <br />
        Screenshot:
